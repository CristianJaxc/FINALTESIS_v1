...
from app.usuario.views import Detalle_usuario, Listado_usuarios,Eliminar_usuario, volunView,\
    ...
    signup_view_voluntario, Usuarios_Sabia,clientes_sabia, Mi_Usuario_Update_Cliente
...
urlpatterns = [
    ...
    path('pagina_cliente/<int:pk>',clientes_sabia.as_view(),name='pagina_cliente'),
    ...
    path('editar_mi_usuario/<int:pk>',  Mi_Usuario_Update_Cliente.as_view(), name='editar_ciente'),
    path('editar_mi_usuario_sabia/<int:pk>',Mi_Usuario_Update_Cliente.as_view(), name='editar_cliente'),
