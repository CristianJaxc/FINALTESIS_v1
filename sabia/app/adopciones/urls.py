...
from app.adopciones.views import PerroCreate, PerroDetail,Eliminar_Solicitud,Eliminar_Perro, PerroUpdate, SolicitudDetail, SolicitudUpdate, adopciones_Listado, Perro_Listado, SolicitudCreate, perro_list
